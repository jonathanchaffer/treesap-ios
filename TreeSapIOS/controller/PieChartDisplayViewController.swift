...
//        }
    ...
    private func updateChartData() {
        ...
        if displayedTree!.otherInfo["rainfallDollars"] != nil, displayedTree!.otherInfo["rainfallDollars"]! > 0 {
            entries.append(PieChartDataEntry(value: displayedTree!.otherInfo["rainfallDollars"]!, label: "Rainwater"))
        }
        if displayedTree!.otherInfo["pollutionDollars"] != nil, displayedTree!.otherInfo["pollutionDollars"]! > 0 {
            entries.append(PieChartDataEntry(value: displayedTree!.otherInfo["pollutionDollars"]!, label: "Air Quality"))
        }
        if displayedTree!.otherInfo["co2Dollars"] != nil, displayedTree!.otherInfo["co2Dollars"]! > 0 {
            entries.append(PieChartDataEntry(value: displayedTree!.otherInfo["co2Dollars"]!, label: "CO2"))
        }
        if displayedTree!.otherInfo["energySavingsDollars"] != nil, displayedTree!.otherInfo["energySavingsDollars"]! > 0 {
            entries.append(PieChartDataEntry(value: displayedTree!.otherInfo["energySavingsDollars"]!, label: "Energy"))
        }
