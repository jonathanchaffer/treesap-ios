...
class UserPreferenceTests: XCTestCase {
    ...
    func testMakesImmediateChanges(){
        ...
        PreferencesManager.setCutoffDistance(78999654)
        XCTAssertEqual(PreferencesManager.getCutoffDistance(), 78999654, "The cutoffDistance should have been set equal to 78999654")
